...
wn = turtle.Screen()
wn.title("Flappy Bird by @Jayanth")
wn.bgcolor("blue")
    ...
    for pipe_pair in pipes:
        ...
        if (player.xcor() + 10 > pipe_top.xcor() - 30) and (player.xcor() - 10 < pipe_top.xcor() + 30):
            if (player.ycor() + 10 > pipe_top.ycor() - 180) or (player.ycor() - 10 < pipe_bottom.ycor() + 180):
                pen.clear()
                pen.write("Game Over", move=False, align="center", font=("Arial", 16, "italic bold"))
                wn.update()
                time.sleep(3)
                # Reset score
                player.score = 0
                ...
                # Reset the pen
                pen.clear()
                pen.write("0", move=False, align="center", font=("Arial", 16, "italic bold"))
        ...
        if pipe_top.xcor() + 30 < player.xcor() - 10:
            ...
            pipe_top.value = 0
            pen.clear()
            pen.write(player.score, move=False, align="center", font=("Arial", 32, "italic"))
